# Modifed from https://github.com/lucidrains/x-transformers/blob/main/x_transformers/autoregressive_wrapper.py
...
class AutoregressiveWrapper(Module):
    ...
    def generate(
        ...
        filter_logits_fn: str | Callable = top_p,
